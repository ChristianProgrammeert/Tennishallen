    ...
    internal static void OnModelCreating(ModelBuilder model)
    {
        model.Entity<Court>().HasData(
            new Court
            {
                ...
                Name = "Roger Federer",
                Description =
                    "Dit tennisveld is vernoemd naar Roger Federer, een van de meest succesvolle en elegante tennisspelers aller tijden. Federer Court staat bekend om zijn perfecte onderhoud, soepele baanoppervlak en gracieuze uitstraling, passend bij de speelstijl van de legendarische speler zelf.",
                Price = 40
            });
        model.Entity<Court>().HasData(
            new Court
        ...
        model.Entity<Court>().HasData(
            new Court
            {
                ...
                Name = "Rafael Nadal",
                Description =
                    "Vernoemd naar Rafael Nadal, bekend om zijn ongeëvenaarde vastberadenheid, veerkracht en onverslaanbare prestaties op gravelbanen. Nadal Court biedt een uitdagende ondergrond die spelers dwingt tot uiterste inspanning en doorzettingsvermogen, net zoals Nadal dat altijd heeft laten zien.",
                Price = 1.50
            });
        model.Entity<Court>().HasData(
            new Court
